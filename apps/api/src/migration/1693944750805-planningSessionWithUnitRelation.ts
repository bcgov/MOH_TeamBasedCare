...
export class planningSessionWithUnitRelation1693944750805 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "planning_session" ADD "profile_option" character varying`);
        await queryRunner.query(`UPDATE "planning_session" SET "profile_option" = "profile" ->> 'profile'`);
        await queryRunner.query(`UPDATE "planning_session" SET "profile_option" = 'scratch' where "profile" ->> 'profile' IS NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "planning_session" ADD CONSTRAINT "FK_75008faf1df43554bee4218692b" FOREIGN KEY ("care_location_id") REFERENCES "unit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        
        // update existing care location data to ICU unit FK
        await queryRunner.query(`UPDATE "planning_session" SET care_location_id = (select id from unit where name = 'icu')`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "planning_session" DROP CONSTRAINT "FK_75008faf1df43554bee4218692b"`);
        ...
        await queryRunner.query(`UPDATE "planning_session" SET "profile" = '{ "profile": "scratch", "careLocation": "" }'::jsonb`);
