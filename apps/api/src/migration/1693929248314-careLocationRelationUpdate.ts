...
export class careLocationRelationUpdate1693929248314 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "care_activity_care_locations_unit" ("care_activity_id" uuid NOT NULL, "unit_id" uuid NOT NULL, CONSTRAINT "PK_8536ed82344ce111811687ecf2e" PRIMARY KEY ("care_activity_id", "unit_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_4d6a0131c8c6374cda5e953065" ON "care_activity_care_locations_unit" ("care_activity_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_674a4833ac0183f68281e21f61" ON "care_activity_care_locations_unit" ("unit_id") `);
        
        await queryRunner.query(`ALTER TABLE "unit" ADD "name" character varying(255)`);        
        await queryRunner.query(`UPDATE "unit" SET "name" = regexp_replace(LOWER("unit_name"), '\W', '', 'gm')`);
        ...
        await queryRunner.query(`ALTER TABLE "care_activity_care_locations_unit" ADD CONSTRAINT "FK_4d6a0131c8c6374cda5e9530652" FOREIGN KEY ("care_activity_id") REFERENCES "care_activity"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "care_activity_care_locations_unit" ADD CONSTRAINT "FK_674a4833ac0183f68281e21f61a" FOREIGN KEY ("unit_id") REFERENCES "unit"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`INSERT INTO "care_activity_care_locations_unit"("care_activity_id", "unit_id") SELECT ca.id as care_activity_id, u.id as unit_id from "care_activity" ca, "unit" u`);

        // TODO: DROP unnecessary table and related constraints for "unit_care_activities_care_activity"
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "care_activity_care_locations_unit" DROP CONSTRAINT "FK_674a4833ac0183f68281e21f61a"`);
        await queryRunner.query(`ALTER TABLE "care_activity_care_locations_unit" DROP CONSTRAINT "FK_4d6a0131c8c6374cda5e9530652"`);
        ...
        await queryRunner.query(`ALTER TABLE "unit" ADD CONSTRAINT "UQ_2b7d9e98d5c89487750c5d227ef" UNIQUE ("unit_name")`);
