...
import { faUsers, faBell, faCog, faComment, faCaretDown } from '@fortawesome/free-solid-svg-icons';
    ...
    return (<>
        ...
        <header className="flex w-full items-center justify-between border-b-2 border-gray-200 p-4">
            ...
            <div className="flex items-center space-x-2">
                <FontAwesomeIcon icon={faUsers} className='h-8 text-bcBluePrimary' />
                <h1 className="text-2xl text-bcBluePrimary flex-col items-start">Resourcing</h1>
            </div>
